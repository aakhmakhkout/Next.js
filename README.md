...
|     6 | Understanding Layouts (`layout.js` & `page.js`) | Not Negotiable  | Frontend           | ✅ Completed |
...
|    10 | Building Reusable Layouts using `layout.js`     | Excellent       | Frontend           | ✅ Completed |
|    11 | Metadata API                                    | Excellent       | Frontend           | ✅ Completed |
|    12 | Custom `not-found.js` Page                      | Excellent       | Frontend           | ✅ Completed |
...
|    36 | `next/image` Image Optimization                 | Not Negotiable  | Frontend           |  ⏳ Pending  |
...
|    41 | Rewrites using `NextResponse`                   | Good to Have    | Frontend           |  ⏳ Pending  |
